...
CREATE OPERATOR FAMILY datetime_ops USING lsm_nbtree_wrapper;

CREATE OPERATOR CLASS date_ops DEFAULT
	FOR TYPE date USING lsm_nbtree_wrapper FAMILY datetime_ops AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS timestamp_ops DEFAULT
	FOR TYPE timestamp USING lsm_nbtree_wrapper FAMILY datetime_ops AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS timestamptz_ops DEFAULT
	FOR TYPE timestamptz USING lsm_nbtree_wrapper FAMILY datetime_ops AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
ALTER OPERATOR FAMILY datetime_ops USING lsm_nbtree_wrapper ADD
	OPERATOR 1  <  (date,timestamp),
	OPERATOR 2  <= (date,timestamp),
	OPERATOR 3  =  (date,timestamp),
	OPERATOR 4  >= (date,timestamp),
...
CREATE OPERATOR CLASS interval_ops DEFAULT
	FOR TYPE interval USING lsm_nbtree_wrapper AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS macaddr_ops DEFAULT
	FOR TYPE macaddr USING lsm_nbtree_wrapper AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS numeric_ops DEFAULT
	FOR TYPE numeric USING lsm_nbtree_wrapper AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS oid_ops DEFAULT
	FOR TYPE oid USING lsm_nbtree_wrapper AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR FAMILY text_ops USING lsm_nbtree_wrapper;

CREATE OPERATOR CLASS text_ops DEFAULT
	FOR TYPE text USING lsm_nbtree_wrapper FAMILY text_ops AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS name_ops DEFAULT
	FOR TYPE name USING lsm_nbtree_wrapper FAMILY text_ops AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
ALTER OPERATOR FAMILY text_ops USING lsm_nbtree_wrapper ADD
	OPERATOR 1  <  (text,name),
	OPERATOR 2  <= (text,name),
	OPERATOR 3  =  (text,name),
	OPERATOR 4  >= (text,name),
...
CREATE OPERATOR CLASS time_ops DEFAULT
	FOR TYPE time USING lsm_nbtree_wrapper AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS timetz_ops DEFAULT
	FOR TYPE timetz USING lsm_nbtree_wrapper AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS money_ops DEFAULT
	FOR TYPE money USING lsm_nbtree_wrapper AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS uuid_ops DEFAULT
	FOR TYPE uuid USING lsm_nbtree_wrapper AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
